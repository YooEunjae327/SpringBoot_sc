...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@popperjs/core'), require('bootstrap/js/dist/util'), require('bootstrap/js/dist/dom/event-handler'), require('bootstrap/js/dist/dom/manipulator'), require('bootstrap/js/dist/dom/selector-engine'), require('bootstrap/js/dist/base-component')) :
  typeof define === 'function' && define.amd ? define(['@popperjs/core', 'bootstrap/js/dist/util', './dom/event-handler', './dom/manipulator', './dom/selector-engine', './base-component'], factory) :
