...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@popperjs/core'), require('bootstrap/js/dist/util'), require('bootstrap/js/dist/util/sanitizer'), require('bootstrap/js/dist/dom/event-handler'), require('bootstrap/js/dist/dom/manipulator'), require('bootstrap/js/dist/base-component'), require('bootstrap/js/dist/util/template-factory')) :
  typeof define === 'function' && define.amd ? define(['@popperjs/core', 'bootstrap/js/dist/util', './util/sanitizer', './dom/event-handler', './dom/manipulator', './base-component', './util/template-factory'], factory) :
